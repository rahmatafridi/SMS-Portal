...
namespace SMSPortal
{
    ...
    public partial class SMSPortalEntity : DbContext
    {
        ...
        public virtual DbSet<SMSSchedule> SMSSchedules { get; set; }
        ...
        public virtual int InsertAssignPackages(Nullable<int> clientId, Nullable<int> packageId, Nullable<System.DateTime> startedDate, Nullable<System.DateTime> endDate, Nullable<int> statusId, Nullable<System.DateTime> createdOn, Nullable<int> createdBy, Nullable<System.DateTime> updatedOn, Nullable<int> updatedBy)
        {
            var clientIdParameter = clientId.HasValue ?
                new ObjectParameter("ClientId", clientId) :
                new ObjectParameter("ClientId", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("InsertAssignPackages", clientIdParameter, packageIdParameter, startedDateParameter, endDateParameter, statusIdParameter, createdOnParameter, createdByParameter, updatedOnParameter, updatedByParameter);
        }
    
        public virtual ObjectResult<GetContactList_Result> GetContactList(Nullable<int> clientId)
        {
            var clientIdParameter = clientId.HasValue ?
                new ObjectParameter("ClientId", clientId) :
                new ObjectParameter("ClientId", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetContactList_Result>("GetContactList", clientIdParameter);
        }
    
        public virtual ObjectResult<GetSchedleList_Result> GetSchedleList(Nullable<int> clientId)
        {
            var clientIdParameter = clientId.HasValue ?
                new ObjectParameter("ClientId", clientId) :
                new ObjectParameter("ClientId", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetSchedleList_Result>("GetSchedleList", clientIdParameter);
        }
    }
}
